...
import photo from "../../assets/photos/imageT2.2.jpg";
        ...
        {!window?.desktop ? (
          ...
          >
            ...
            <ImageContainerSC
              ...
              wTS="200px"
              wM="130px"
              m="0px 0px 0px min(260px, 24vw)"
              mM="0px 0px 0px 100px"
              h="260px"
              hM="150px"
              window={window}
            >
              <ResponsiveImageSC window={window} src={photo} />
            </ImageContainerSC>
          </Section>
        ) : (
          <>
